...
export const metadata = {
  title: "الخدمة رقم #1 في المملكة - توصيل طالبات الكلية التقنية الرقمية",
  description: "خدمة نقل الطالبات وتوصيل الموظفات بأعلى معايير أمان في المملكة. انضمي إلينا لتجربة مريحة وآمنة مع سائقين محترفين - نقل الكلية الرقمية التقنية للبنات في الرياض",
  keywords: [
