...
<div className="mb-16">
  ...
  <p className="mx-auto mt-6 max-w-2xl w-2/3 sm:w-3/4 text-pretty text-center text-md font-medium text-gray-500 sm:text-lg/8">  نحن نحرص حرص تام على سلامة عملائنا في كل رحلة يعني راحة وامان في طريقك للدوام</p>
</div>
