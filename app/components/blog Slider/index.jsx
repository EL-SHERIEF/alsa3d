    ...
    return (
        <div className='my-24'>
            ...
            <Slider {...settings} className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-3 relative">
                {data.map((post) => (
                    <section key={post._id} className='relative'>
                        <div className="h-[400px] md:h-[450px] mx-2 max-w-2xl lg:max-w-4xl rounded-2xl shadow-lg px-4 py-4 sm:py-2 sm:px-2 flex flex-col justify-between  bg-[#ffffffad] backdrop-blur-md border-x-gray-200 border-2 z-10">
                            <figure className="text-center">
                                ...
                                {post.mainImage?.asset && (
                                    <Image
                                        ...
                                        width={400}
                                        height={200}
                                        className="rounded-lg sm:rounded-md w-full h-[190px] sm:h-[220px] object-cover"
                                    />
                                )}
                                {/* Blog Title */}
                                
                                <blockquote className="text-center w-[90%]">
                                    <h2 className=' text-xl/8 font-semibold text-gray-900 sm:text-1xl/8 mt-3 line-clamp-2'>{post.title}</h2>
                                </blockquote>
                            ...
                            <Link href={`/blog/${post.slug.current}`} passHref className='my-5 mx-7'>
