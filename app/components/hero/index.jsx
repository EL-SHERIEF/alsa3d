    ...
    <div className="w-[93vw] md:w-[97vw] mx-auto h-[26rem] md:h-[calc(100vh-106px)] relative mt-14 md:mt-16 overflow-hidden rounded-xl">
      <Slider {...settings} ref={sliderRef}>
        {slides.map((slide, index) => (
           ...
           <div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full z-0"><Image src={slide.image} className="left-0 w-full h-full object-cover z-0" width={1000} height={1000} alt="انضمي لنا"/></div>
