      ...
      <Slider {...settings} ref={sliderRef}>
        {slides.map((slide, index) => (
           ...
           <div className="mx-1 md:mx-5 w-[90%] md:max-w-4xl ps-5 pb-5 md:ps-10 md:pb-10 z-10 flex flex-col gap-[2px] sm:gap-2 items-start">
                         ...
                         <Link className='rounded-xl bg-custom-gradient py-4 px-10 shadow-sm text-white w-fit flex flex-row gap-1 items-center font-bold hover:-translate-x-3 duration-200' href={slide.linkHref} target="_blank">{slide.linkText}
