...
const slides = [
  ...
  {
    image: frame1,
    title: 'خدمات نقل مريحة و امنة, ابو حسن لتوصيل الموظفات',
    tag: 'توصيل موظفات المولات',
    linkText: 'انضمي لنا',
    linkHref: 'https://wa.me/966594740105?text=اشتراك',
    alt: 'توصيل موظفات مول الرياض',
  },
  {
    image: frame3,
    title: 'لان السائق هو من يجعل الرحلة مناسبة ضممنا مجموعة من امهر سائقين المملكة',
    tag: 'توصيل موظفات الرياض',
