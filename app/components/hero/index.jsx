...
const slides = [
  ...
  {
    image: frame1,
    title: 'حجزي رحلتك بأمان وسرعة في أحياء الدخل المحدود ونجم الدين',
        ...
        {slides.map((slide, index) => (
          <div key={index} dir="rtl" className="h-[26rem] md:h-[calc(100vh-106px)] w-full flex flex-col relative justify-end items-start">
            <div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full z-0">
              <Image src={slide.image} className="left-0 w-full h-full object-cover z-0" fill loading="eager" placeholder="blur" quality={75} alt={slide.alt} />
            </div>
