...
export default function Testimonials() {
    const testimonials = [
        ...
        {
            quote: "أفضل خدمة نقل معلمات في الرياض! التزموا بتوصيلي إلى المدرسة في نجم الدين يوميًا بأمان وراحة، والأسعار معقولة جدًا.",
            name: "أم محمد",
            title: "طالبة بكلية التقنية",
        },
        {
            quote: "خدمة سائقات توصيل غرب الرياض رائعة! السائقة محترفة وودودة، وتضمن الخصوصية والأمان أثناء نقلي إلى الكلية التقنية.",
            name: "أم محمد",
            title: "سارة العتيبي",
        },
        {
            quote: "خدمة توصيل موظفات غرب الرياض ممتازة! السائقون محترفون ودقيقون في المواعيد، وأشعر بالأمان التام أثناء التنقل إلى العمل في حي طويق.",
            name: "أم عبدالله",
            title: "طالبة بكلية التقنية",
        },
        {
            quote: "ما شاء الله ممتازين ❤🧡",
