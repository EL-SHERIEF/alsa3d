  ...
  return (
    ...
    />
            ...
            <div className="lg:mx-auto text-start">
                <h4 className="text-lg text-gray-900 font-medium mb-7">الصفحات</h4>
            ...
            <div className="lg:mx-auto text-start ">
                <h4 className="text-lg text-gray-900 font-medium mb-7">الاكثر زيارة</h4>
                <ul className="text-sm  transition-all duration-500">
        ...
        <div className="py-7 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                <span className="text-sm text-gray-500 tracking-wide ">©<a href="https://www.linkedin.com/in/elsherief/" className='text-green-500 duration-150'>ابو حسن</a> جميع الحقوق محفوظة</span>
